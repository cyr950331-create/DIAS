...
languages = {
    "zh": {
        ...
        "qq_xlabel": "理论分位数",
        "qq_ylabel": "样本分位数",
        "table_header_column": "列名",  # 新增
        "table_header_ks": "KS统计量",   # 新增
        "table_header_p": "P值",        # 新增
        "table_header_result": "结果解读" # 新增
    },
    "en": {
        "title": "KS Test",
        ...
        "table_header_column": "Column Name",  # 新增
        "table_header_ks": "KS Statistic",     # 新增
        "table_header_p": "P-value",           # 新增
        "table_header_result": "Result Interpretation" # 新增
    }
}
